...
_MANUAL_SCAFFOLDS: tuple[tuple[str, str], ...] = (
    ...
    (
        "fx_custom.yaml",
        "# Project-specific engine effects callable from [[fx]] inside a\n"
        "# .scene file. The compiler merges this list with the auto-generated\n"
        "# fx.yaml (base-game effects). This file is hand-maintained and is\n"
        "# NEVER regenerated by the refresh, so mod FX are never lost.\n"
        "#\n"
        "# Each entry mirrors the fx.yaml schema:\n"
        "# effects:\n"
        "#   - name: mymod_do_thing\n"
        "#     signature: \"mymod_do_thing(Character) -> None\"\n"
        "#     source_file: PregnancyMod/game/.../file.rpy\n"
        "effects: []\n",
    ),
    (
